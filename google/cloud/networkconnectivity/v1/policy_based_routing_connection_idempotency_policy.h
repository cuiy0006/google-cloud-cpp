...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKCONNECTIVITY_V1_POLICY_BASED_ROUTING_CONNECTION_IDEMPOTENCY_POLICY_H
...
class PolicyBasedRoutingServiceConnectionIdempotencyPolicy {
 public:
  virtual ~PolicyBasedRoutingServiceConnectionIdempotencyPolicy();

  /// Create a new copy of this object.
  virtual std::unique_ptr<PolicyBasedRoutingServiceConnectionIdempotencyPolicy>
  clone() const;

  virtual google::cloud::Idempotency ListPolicyBasedRoutes(
      google::cloud::networkconnectivity::v1::ListPolicyBasedRoutesRequest
          request);

  virtual google::cloud::Idempotency GetPolicyBasedRoute(
      google::cloud::networkconnectivity::v1::GetPolicyBasedRouteRequest const&
          request);

  virtual google::cloud::Idempotency CreatePolicyBasedRoute(
      google::cloud::networkconnectivity::v1::
          CreatePolicyBasedRouteRequest const& request);

  virtual google::cloud::Idempotency DeletePolicyBasedRoute(
      google::cloud::networkconnectivity::v1::
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKCONNECTIVITY_V1_POLICY_BASED_ROUTING_CONNECTION_IDEMPOTENCY_POLICY_H
