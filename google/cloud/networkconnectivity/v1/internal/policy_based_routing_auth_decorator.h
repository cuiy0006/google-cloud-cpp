...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKCONNECTIVITY_V1_INTERNAL_POLICY_BASED_ROUTING_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKCONNECTIVITY_V1_INTERNAL_POLICY_BASED_ROUTING_AUTH_DECORATOR_H
...
class PolicyBasedRoutingServiceAuth : public PolicyBasedRoutingServiceStub {
 public:
  ~PolicyBasedRoutingServiceAuth() override = default;
  PolicyBasedRoutingServiceAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_NETWORKCONNECTIVITY_V1_INTERNAL_POLICY_BASED_ROUTING_AUTH_DECORATOR_H
