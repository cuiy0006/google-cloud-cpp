...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_MOCKS_MOCK_AUTOKEY_ADMIN_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_MOCKS_MOCK_AUTOKEY_ADMIN_CONNECTION_H
...
/**
 * A class to mock `AutokeyAdminConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `AutokeyAdminClient`. To do so,
 * construct an object of type `AutokeyAdminClient` with an instance of this
 ...
 */
class MockAutokeyAdminConnection : public kms_v1::AutokeyAdminConnection {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_MOCKS_MOCK_AUTOKEY_ADMIN_CONNECTION_H
