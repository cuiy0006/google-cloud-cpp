...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_TRACING_STUB_H
...
class AutokeyTracingStub : public AutokeyStub {
 public:
  ~AutokeyTracingStub() override = default;

  explicit AutokeyTracingStub(std::shared_ptr<AutokeyStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_TRACING_STUB_H
