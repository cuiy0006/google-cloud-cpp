...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_LOGGING_DECORATOR_H
...
class AutokeyAdminLogging : public AutokeyAdminStub {
 public:
  ~AutokeyAdminLogging() override = default;
  AutokeyAdminLogging(std::shared_ptr<AutokeyAdminStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_ADMIN_LOGGING_DECORATOR_H
