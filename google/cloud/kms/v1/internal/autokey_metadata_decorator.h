...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_METADATA_DECORATOR_H
...
class AutokeyMetadata : public AutokeyStub {
 public:
  ~AutokeyMetadata() override = default;
  AutokeyMetadata(std::shared_ptr<AutokeyStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_KMS_V1_INTERNAL_AUTOKEY_METADATA_DECORATOR_H
