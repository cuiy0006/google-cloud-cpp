...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_MOCKS_MOCK_KNOWLEDGE_BASES_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_MOCKS_MOCK_KNOWLEDGE_BASES_CONNECTION_H
...
/**
 * A class to mock `KnowledgeBasesConnection`.
 *
 * Application developers may want to test their code with simulated responses,
 * including errors, from an object of type `KnowledgeBasesClient`. To do so,
 * construct an object of type `KnowledgeBasesClient` with an instance of this
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_MOCKS_MOCK_KNOWLEDGE_BASES_CONNECTION_H
