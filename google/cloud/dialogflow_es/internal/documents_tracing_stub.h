...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_DOCUMENTS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_DOCUMENTS_TRACING_STUB_H
...
class DocumentsTracingStub : public DocumentsStub {
 public:
  ~DocumentsTracingStub() override = default;

  explicit DocumentsTracingStub(std::shared_ptr<DocumentsStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_ES_INTERNAL_DOCUMENTS_TRACING_STUB_H
