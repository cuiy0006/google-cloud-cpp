...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVELOPERCONNECT_V1_INTERNAL_DEVELOPER_CONNECT_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVELOPERCONNECT_V1_INTERNAL_DEVELOPER_CONNECT_LOGGING_DECORATOR_H
...
class DeveloperConnectLogging : public DeveloperConnectStub {
 public:
  ~DeveloperConnectLogging() override = default;
  DeveloperConnectLogging(std::shared_ptr<DeveloperConnectStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DEVELOPERCONNECT_V1_INTERNAL_DEVELOPER_CONNECT_LOGGING_DECORATOR_H
