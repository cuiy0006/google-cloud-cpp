...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RAPIDMIGRATIONASSESSMENT_V1_INTERNAL_RAPID_MIGRATION_ASSESSMENT_TRACING_STUB_H
...
class RapidMigrationAssessmentTracingStub
    : public RapidMigrationAssessmentStub {
 public:
  ~RapidMigrationAssessmentTracingStub() override = default;

  explicit RapidMigrationAssessmentTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RAPIDMIGRATIONASSESSMENT_V1_INTERNAL_RAPID_MIGRATION_ASSESSMENT_TRACING_STUB_H
