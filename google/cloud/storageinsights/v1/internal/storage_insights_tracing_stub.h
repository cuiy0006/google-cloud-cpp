...
class StorageInsightsTracingStub : public StorageInsightsStub {
 public:
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_STORAGEINSIGHTS_V1_INTERNAL_STORAGE_INSIGHTS_TRACING_STUB_H
