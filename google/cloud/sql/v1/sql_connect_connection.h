...
class SqlConnectServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  ...
  virtual std::unique_ptr<SqlConnectServiceRetryPolicy> clone() const = 0;
};
...
class SqlConnectServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<SqlConnectServiceRetryPolicy> clone() const override {
    return std::make_unique<SqlConnectServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
class SqlConnectServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<SqlConnectServiceRetryPolicy> clone() const override {
    return std::make_unique<SqlConnectServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 *
 * For mocking, see `sql_v1_mocks::MockSqlConnectServiceConnection`.
 */
class SqlConnectServiceConnection {
 public:
  virtual ~SqlConnectServiceConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_CONNECT_CONNECTION_H
