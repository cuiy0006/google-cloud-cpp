...
class SqlEventsServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<SqlEventsServiceRetryPolicy> clone() const = 0;
};
...
class SqlEventsServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<SqlEventsServiceRetryPolicy> clone() const override {
    return std::make_unique<SqlEventsServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
class SqlEventsServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<SqlEventsServiceRetryPolicy> clone() const override {
    return std::make_unique<SqlEventsServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 * sets in `SqlEventsServiceClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `SqlEventsServiceClient`.
 *
 * To create a concrete instance, see `MakeSqlEventsServiceConnection()`.
 *
 * For mocking, see `sql_v1_mocks::MockSqlEventsServiceConnection`.
 */
class SqlEventsServiceConnection {
 public:
  virtual ~SqlEventsServiceConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_EVENTS_CONNECTION_H
