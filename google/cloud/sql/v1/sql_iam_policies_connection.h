 ...
 *
 * For mocking, see `sql_v1_mocks::MockSqlIamPoliciesServiceConnection`.
 */
class SqlIamPoliciesServiceConnection {
 public:
  virtual ~SqlIamPoliciesServiceConnection() = 0;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_SQL_IAM_POLICIES_CONNECTION_H
