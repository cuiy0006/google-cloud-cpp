...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_SSL_CERTS_REST_STUB_H
...
class SqlSslCertsServiceRestStub {
 public:
  virtual ~SqlSslCertsServiceRestStub() = default;
...
class DefaultSqlSslCertsServiceRestStub : public SqlSslCertsServiceRestStub {
 public:
  ~DefaultSqlSslCertsServiceRestStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_SSL_CERTS_REST_STUB_H
