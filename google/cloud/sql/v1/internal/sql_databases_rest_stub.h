...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_DATABASES_REST_STUB_H
...
class SqlDatabasesServiceRestStub {
 public:
  virtual ~SqlDatabasesServiceRestStub() = default;
...
class DefaultSqlDatabasesServiceRestStub : public SqlDatabasesServiceRestStub {
 public:
  ~DefaultSqlDatabasesServiceRestStub() override = default;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_DATABASES_REST_STUB_H
