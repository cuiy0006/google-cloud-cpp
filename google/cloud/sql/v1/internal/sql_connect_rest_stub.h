...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_CONNECT_REST_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_CONNECT_REST_STUB_H
...
class SqlConnectServiceRestStub {
 public:
  virtual ~SqlConnectServiceRestStub() = default;
...
class DefaultSqlConnectServiceRestStub : public SqlConnectServiceRestStub {
 public:
  ~DefaultSqlConnectServiceRestStub() override = default;

  explicit DefaultSqlConnectServiceRestStub(Options options);
  DefaultSqlConnectServiceRestStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_SQL_V1_INTERNAL_SQL_CONNECT_REST_STUB_H
