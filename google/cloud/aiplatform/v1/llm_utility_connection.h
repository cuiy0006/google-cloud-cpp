...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_LLM_UTILITY_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_LLM_UTILITY_CONNECTION_H
...
#include <google/cloud/aiplatform/v1/llm_utility_service.pb.h>
...
/// The retry policy for `LlmUtilityServiceConnection`.
class LlmUtilityServiceRetryPolicy : public ::google::cloud::RetryPolicy {
 public:
  /// Creates a new instance of the policy, reset to the initial state.
  virtual std::unique_ptr<LlmUtilityServiceRetryPolicy> clone() const = 0;
};

/**
 * A retry policy for `LlmUtilityServiceConnection` based on counting errors.
 *
...
class LlmUtilityServiceLimitedErrorCountRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<LlmUtilityServiceRetryPolicy> clone() const override {
    return std::make_unique<LlmUtilityServiceLimitedErrorCountRetryPolicy>(
        maximum_failures());
  }
...
/**
 * A retry policy for `LlmUtilityServiceConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
class LlmUtilityServiceLimitedTimeRetryPolicy
 ...
 public:
  ...
  std::unique_ptr<LlmUtilityServiceRetryPolicy> clone() const override {
    return std::make_unique<LlmUtilityServiceLimitedTimeRetryPolicy>(
        maximum_duration());
  }
 ...
 *
 * For mocking, see `aiplatform_v1_mocks::MockLlmUtilityServiceConnection`.
 */
class LlmUtilityServiceConnection {
 public:
  virtual ~LlmUtilityServiceConnection() = 0;
 ...
 * - `google::cloud::aiplatform_v1::LlmUtilityServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_LLM_UTILITY_CONNECTION_H
