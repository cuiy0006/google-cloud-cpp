...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_FEATURESTORE_ONLINE_SERVING_CONNECTION_IDEMPOTENCY_POLICY_H
...
class FeaturestoreOnlineServingServiceConnectionIdempotencyPolicy {
 public:
  virtual ~FeaturestoreOnlineServingServiceConnectionIdempotencyPolicy();
  ...
  virtual google::cloud::Idempotency ReadFeatureValues(
      google::cloud::aiplatform::v1::ReadFeatureValuesRequest const& request);

  virtual google::cloud::Idempotency WriteFeatureValues(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_FEATURESTORE_ONLINE_SERVING_CONNECTION_IDEMPOTENCY_POLICY_H
