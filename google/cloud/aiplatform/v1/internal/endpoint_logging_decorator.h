...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_ENDPOINT_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_ENDPOINT_LOGGING_DECORATOR_H
...
class EndpointServiceLogging : public EndpointServiceStub {
 public:
  ~EndpointServiceLogging() override = default;
  EndpointServiceLogging(std::shared_ptr<EndpointServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_ENDPOINT_LOGGING_DECORATOR_H
