...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_DATASET_TRACING_STUB_H
...
class DatasetServiceTracingStub : public DatasetServiceStub {
 public:
  ~DatasetServiceTracingStub() override = default;

  explicit DatasetServiceTracingStub(std::shared_ptr<DatasetServiceStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_DATASET_TRACING_STUB_H
