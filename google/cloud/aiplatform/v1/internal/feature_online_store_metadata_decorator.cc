...
FeatureOnlineStoreServiceMetadata::FeatureOnlineStoreServiceMetadata(
...
FeatureOnlineStoreServiceMetadata::GetLocation(
    grpc::ClientContext& context, Options const& options,
...
FeatureOnlineStoreServiceMetadata::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy>
FeatureOnlineStoreServiceMetadata::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
FeatureOnlineStoreServiceMetadata::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
