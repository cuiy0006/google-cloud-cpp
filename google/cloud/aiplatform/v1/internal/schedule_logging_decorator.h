...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_SCHEDULE_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_SCHEDULE_LOGGING_DECORATOR_H
...
class ScheduleServiceLogging : public ScheduleServiceStub {
 public:
  ~ScheduleServiceLogging() override = default;
  ScheduleServiceLogging(std::shared_ptr<ScheduleServiceStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_SCHEDULE_LOGGING_DECORATOR_H
