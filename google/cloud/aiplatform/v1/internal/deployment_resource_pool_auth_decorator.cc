...
future<StatusOr<google::longrunning::Operation>>
DeploymentResourcePoolServiceAuth::AsyncUpdateDeploymentResourcePool(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options = std::move(options),
        ...
        return child->AsyncUpdateDeploymentResourcePool(
            cq, *std::move(context), std::move(options), request);
      });
}

StatusOr<google::longrunning::Operation>
DeploymentResourcePoolServiceAuth::UpdateDeploymentResourcePool(
    grpc::ClientContext& context, Options options,
    google::cloud::aiplatform::v1::UpdateDeploymentResourcePoolRequest const&
        request) {
  auto status = auth_->ConfigureContext(context);
...
DeploymentResourcePoolServiceAuth::ListLocations(
    grpc::ClientContext& context, Options const& options,
...
DeploymentResourcePoolServiceAuth::GetLocation(
    grpc::ClientContext& context, Options const& options,
...
DeploymentResourcePoolServiceAuth::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy>
DeploymentResourcePoolServiceAuth::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
DeploymentResourcePoolServiceAuth::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
