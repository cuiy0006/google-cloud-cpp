...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURESTORE_ONLINE_SERVING_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURESTORE_ONLINE_SERVING_TRACING_STUB_H
...
class FeaturestoreOnlineServingServiceTracingStub
    : public FeaturestoreOnlineServingServiceStub {
 public:
  ~FeaturestoreOnlineServingServiceTracingStub() override = default;

  explicit FeaturestoreOnlineServingServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_INTERNAL_FEATURESTORE_ONLINE_SERVING_TRACING_STUB_H
