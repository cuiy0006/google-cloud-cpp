...
PipelineServiceConnectionImpl::ListLocations(
...
PipelineServiceConnectionImpl::GetLocation(
...
StatusOr<google::iam::v1::Policy> PipelineServiceConnectionImpl::SetIamPolicy(
...
StatusOr<google::iam::v1::Policy> PipelineServiceConnectionImpl::GetIamPolicy(
...
PipelineServiceConnectionImpl::TestIamPermissions(
