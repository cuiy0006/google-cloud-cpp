...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_SCHEDULE_CONNECTION_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_SCHEDULE_CONNECTION_H
...
#include <google/cloud/aiplatform/v1/schedule_service.pb.h>
...
/**
 * A retry policy for `ScheduleServiceConnection` based on elapsed time.
 *
 * This policy stops retrying if:
 * - An RPC returns a non-transient error.
...
/**
 * The `ScheduleServiceConnection` object for `ScheduleServiceClient`.
 *
 * This interface defines virtual methods for each of the user-facing overload
 * sets in `ScheduleServiceClient`. This allows users to inject custom behavior
 * (e.g., with a Google Mock object) when writing tests that use objects of type
 * `ScheduleServiceClient`.
 *
 * To create a concrete instance, see `MakeScheduleServiceConnection()`.
 *
 * For mocking, see `aiplatform_v1_mocks::MockScheduleServiceConnection`.
 */
class ScheduleServiceConnection {
 public:
  virtual ~ScheduleServiceConnection() = 0;
 ...
 * - `google::cloud::aiplatform_v1::ScheduleServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_AIPLATFORM_V1_SCHEDULE_CONNECTION_H
