 ...
 *
 * For mocking, see `retail_v2_mocks::MockUserEventServiceConnection`.
 */
 ...
 * - `google::cloud::retail_v2::UserEventServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_RETAIL_V2_USER_EVENT_CONNECTION_H
