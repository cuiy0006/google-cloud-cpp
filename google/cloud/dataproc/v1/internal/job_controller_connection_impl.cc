...
StatusOr<google::iam::v1::Policy> JobControllerConnectionImpl::SetIamPolicy(
...
StatusOr<google::iam::v1::Policy> JobControllerConnectionImpl::GetIamPolicy(
...
JobControllerConnectionImpl::TestIamPermissions(
