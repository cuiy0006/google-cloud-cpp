...
#include "google/cloud/dataproc/v1/internal/session_controller_auth_decorator.h"
...
SessionControllerAuth::SessionControllerAuth(
    std::shared_ptr<google::cloud::internal::GrpcAuthenticationStrategy> auth,
    std::shared_ptr<SessionControllerStub> child)
    : auth_(std::move(auth)), child_(std::move(child)) {}

future<StatusOr<google::longrunning::Operation>>
SessionControllerAuth::AsyncCreateSession(
...
SessionControllerAuth::ListSessions(
    grpc::ClientContext& context, Options const& options,
...
future<StatusOr<google::longrunning::Operation>>
SessionControllerAuth::AsyncTerminateSession(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options = std::move(options),
        ...
        return child->AsyncTerminateSession(cq, *std::move(context),
                                            std::move(options), request);
      });
}
...
StatusOr<google::iam::v1::Policy> SessionControllerAuth::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy> SessionControllerAuth::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
SessionControllerAuth::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
...
future<StatusOr<google::longrunning::Operation>>
SessionControllerAuth::AsyncGetOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
...
future<Status> SessionControllerAuth::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
