...
NodeGroupControllerAuth::NodeGroupControllerAuth(
    std::shared_ptr<google::cloud::internal::GrpcAuthenticationStrategy> auth,
    std::shared_ptr<NodeGroupControllerStub> child)
    : auth_(std::move(auth)), child_(std::move(child)) {}

future<StatusOr<google::longrunning::Operation>>
NodeGroupControllerAuth::AsyncCreateNodeGroup(
  ...
  return auth_->AsyncConfigureContext(std::move(context))
      .then([cq, child = child_, options = std::move(options),
        ...
        return child->AsyncCreateNodeGroup(cq, *std::move(context),
...
StatusOr<google::iam::v1::Policy> NodeGroupControllerAuth::SetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
StatusOr<google::iam::v1::Policy> NodeGroupControllerAuth::GetIamPolicy(
    grpc::ClientContext& context, Options const& options,
...
NodeGroupControllerAuth::TestIamPermissions(
    grpc::ClientContext& context, Options const& options,
...
future<StatusOr<google::longrunning::Operation>>
NodeGroupControllerAuth::AsyncGetOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
...
future<Status> NodeGroupControllerAuth::AsyncCancelOperation(
    google::cloud::CompletionQueue& cq,
    std::shared_ptr<grpc::ClientContext> context,
    google::cloud::internal::ImmutableOptions options,
