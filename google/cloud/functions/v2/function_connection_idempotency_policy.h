...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FUNCTIONS_V2_FUNCTION_CONNECTION_IDEMPOTENCY_POLICY_H
...
class FunctionServiceConnectionIdempotencyPolicy {
 public:
  virtual ~FunctionServiceConnectionIdempotencyPolicy();

  /// Create a new copy of this object.
  virtual std::unique_ptr<FunctionServiceConnectionIdempotencyPolicy> clone()
      const;
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_FUNCTIONS_V2_FUNCTION_CONNECTION_IDEMPOTENCY_POLICY_H
