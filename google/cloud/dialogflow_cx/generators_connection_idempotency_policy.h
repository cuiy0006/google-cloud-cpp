...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_GENERATORS_CONNECTION_IDEMPOTENCY_POLICY_H
...
class GeneratorsConnectionIdempotencyPolicy {
 public:
  virtual ~GeneratorsConnectionIdempotencyPolicy();

  /// Create a new copy of this object.
  virtual std::unique_ptr<GeneratorsConnectionIdempotencyPolicy> clone() const;

  virtual google::cloud::Idempotency ListGenerators(
      google::cloud::dialogflow::cx::v3::ListGeneratorsRequest request);

  virtual google::cloud::Idempotency GetGenerator(
      google::cloud::dialogflow::cx::v3::GetGeneratorRequest const& request);

  virtual google::cloud::Idempotency CreateGenerator(
      google::cloud::dialogflow::cx::v3::CreateGeneratorRequest const& request);

  virtual google::cloud::Idempotency UpdateGenerator(
      google::cloud::dialogflow::cx::v3::UpdateGeneratorRequest const& request);

  virtual google::cloud::Idempotency DeleteGenerator(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_GENERATORS_CONNECTION_IDEMPOTENCY_POLICY_H
