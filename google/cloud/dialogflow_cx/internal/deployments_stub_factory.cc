...
#include "google/cloud/dialogflow_cx/internal/deployments_metadata_decorator.h"
...
std::shared_ptr<DeploymentsStub> CreateDefaultDeploymentsStub(
  ...
  auto service_grpc_stub =
      google::cloud::dialogflow::cx::v3::Deployments::NewStub(channel);
  auto service_locations_stub =
      google::cloud::location::Locations::NewStub(channel);
  std::shared_ptr<DeploymentsStub> stub =
      std::make_shared<DefaultDeploymentsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeDeploymentsTracingStub(std::move(stub));
  }
  return stub;
}
