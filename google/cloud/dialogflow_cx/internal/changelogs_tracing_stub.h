...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_CHANGELOGS_TRACING_STUB_H
...
class ChangelogsTracingStub : public ChangelogsStub {
 public:
  ~ChangelogsTracingStub() override = default;

  explicit ChangelogsTracingStub(std::shared_ptr<ChangelogsStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_CHANGELOGS_TRACING_STUB_H
