...
std::shared_ptr<FlowsStub> CreateDefaultFlowsStub(
  ...
  auto service_grpc_stub =
      google::cloud::dialogflow::cx::v3::Flows::NewStub(channel);
  auto service_locations_stub =
      google::cloud::location::Locations::NewStub(channel);
  std::shared_ptr<FlowsStub> stub = std::make_shared<DefaultFlowsStub>(
  ...
  if (internal::TracingEnabled(options)) {
    stub = MakeFlowsTracingStub(std::move(stub));
  }
  return stub;
}
