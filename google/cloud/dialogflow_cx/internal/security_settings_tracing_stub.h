...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_TRACING_STUB_H
...
class SecuritySettingsServiceTracingStub : public SecuritySettingsServiceStub {
 public:
  ~SecuritySettingsServiceTracingStub() override = default;

  explicit SecuritySettingsServiceTracingStub(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_SECURITY_SETTINGS_TRACING_STUB_H
