...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_EXPERIMENTS_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_EXPERIMENTS_TRACING_STUB_H
...
class ExperimentsTracingStub : public ExperimentsStub {
 public:
  ~ExperimentsTracingStub() override = default;

  explicit ExperimentsTracingStub(std::shared_ptr<ExperimentsStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DIALOGFLOW_CX_INTERNAL_EXPERIMENTS_TRACING_STUB_H
