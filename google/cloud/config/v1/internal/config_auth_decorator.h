...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIG_V1_INTERNAL_CONFIG_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIG_V1_INTERNAL_CONFIG_AUTH_DECORATOR_H
...
class ConfigAuth : public ConfigStub {
 public:
  ~ConfigAuth() override = default;
  ConfigAuth(
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_CONFIG_V1_INTERNAL_CONFIG_AUTH_DECORATOR_H
