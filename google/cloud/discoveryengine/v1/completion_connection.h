 ...
 *
 * For mocking, see `discoveryengine_v1_mocks::MockCompletionServiceConnection`.
 */
 ...
 * - `google::cloud::discoveryengine_v1::CompletionServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_COMPLETION_CONNECTION_H
