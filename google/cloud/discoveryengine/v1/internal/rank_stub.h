...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_RANK_STUB_H
...
class RankServiceStub {
 public:
  virtual ~RankServiceStub() = 0;

  virtual StatusOr<google::cloud::discoveryengine::v1::RankResponse> Rank(
      grpc::ClientContext& context, Options const& options,
      google::cloud::discoveryengine::v1::RankRequest const& request) = 0;
};

class DefaultRankServiceStub : public RankServiceStub {
 public:
  explicit DefaultRankServiceStub(
      std::unique_ptr<
          google::cloud::discoveryengine::v1::RankService::StubInterface>
          grpc_stub)
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_RANK_STUB_H
