...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_RECOMMENDATION_STUB_H
...
class RecommendationServiceStub {
 public:
  virtual ~RecommendationServiceStub() = 0;

  virtual StatusOr<google::cloud::discoveryengine::v1::RecommendResponse>
  Recommend(
      grpc::ClientContext& context, Options const& options,
      google::cloud::discoveryengine::v1::RecommendRequest const& request) = 0;
};

class DefaultRecommendationServiceStub : public RecommendationServiceStub {
 public:
  explicit DefaultRecommendationServiceStub(
      std::unique_ptr<google::cloud::discoveryengine::v1::
                          RecommendationService::StubInterface>
          grpc_stub)
 ...
 private:
  std::unique_ptr<
      google::cloud::discoveryengine::v1::RecommendationService::StubInterface>
      grpc_stub_;
};
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DISCOVERYENGINE_V1_INTERNAL_RECOMMENDATION_STUB_H
