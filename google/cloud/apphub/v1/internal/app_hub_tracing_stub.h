...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_TRACING_STUB_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_TRACING_STUB_H
...
class AppHubTracingStub : public AppHubStub {
 public:
  ~AppHubTracingStub() override = default;

  explicit AppHubTracingStub(std::shared_ptr<AppHubStub> child);
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_TRACING_STUB_H
