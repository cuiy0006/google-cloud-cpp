...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_LOGGING_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_LOGGING_DECORATOR_H
...
class AppHubLogging : public AppHubStub {
 public:
  ~AppHubLogging() override = default;
  AppHubLogging(std::shared_ptr<AppHubStub> child,
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_APPHUB_V1_INTERNAL_APP_HUB_LOGGING_DECORATOR_H
