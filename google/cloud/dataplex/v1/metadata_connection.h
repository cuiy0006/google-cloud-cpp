 ...
 *
 * For mocking, see `dataplex_v1_mocks::MockMetadataServiceConnection`.
 */
 ...
 * - `google::cloud::dataplex_v1::MetadataServicePolicyOptionList`
 *
...
#endif  // GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_METADATA_CONNECTION_H
