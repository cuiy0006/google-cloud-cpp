...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_CONTENT_AUTH_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_CONTENT_AUTH_DECORATOR_H
...
class ContentServiceAuth : public ContentServiceStub {
 public:
  ~ContentServiceAuth() override = default;
  ContentServiceAuth(
