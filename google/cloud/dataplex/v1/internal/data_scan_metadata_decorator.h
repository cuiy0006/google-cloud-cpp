...
#ifndef GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATA_SCAN_METADATA_DECORATOR_H
#define GOOGLE_CLOUD_CPP_GOOGLE_CLOUD_DATAPLEX_V1_INTERNAL_DATA_SCAN_METADATA_DECORATOR_H
...
class DataScanServiceMetadata : public DataScanServiceStub {
 public:
  ~DataScanServiceMetadata() override = default;
  DataScanServiceMetadata(
